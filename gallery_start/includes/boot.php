...
defined('SITE_ROOT') ? null : define('SITE_ROOT', DS.'Applications'.DS.'MAMP'.DS.'htdocs'.DS.'oop'.DS.'gallery_start');
defined('INCLUDES_PATH') ? null : define('INCLUDES_PATH', SITE_ROOT.DS.'includes');
defined('ASSETS_PATH') ? null : define('ASSETS_PATH', '/oop/gallery_start/public/assets');
